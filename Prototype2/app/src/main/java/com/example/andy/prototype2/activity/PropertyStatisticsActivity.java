...
public class PropertyStatisticsActivity extends RootActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.statistics_property);
    ...
    private void drawPropertyChart(JSONArray jArr){
        ...
        try {
            for (int i = 0; i < jArr.length(); i++) {
                ...
                yvalues.add(new PieEntry(jObj.getInt("properties"), jObj.getString("name")));
            }

            PieDataSet dataSet = new PieDataSet(yvalues, "Properties");
