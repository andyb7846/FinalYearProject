...
public class DeviceStatisticsActivity extends RootActivity {
    ...
    private void drawDeviceChart(JSONArray jArr){
        ...
        try {
            for (int i = 0; i < jArr.length(); i++) {
                ...
                yvalues.add(new PieEntry(jObj.getInt("devices"), jObj.getString("name")));
            }
