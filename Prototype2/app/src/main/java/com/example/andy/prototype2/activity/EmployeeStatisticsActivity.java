...
public class EmployeeStatisticsActivity extends RootActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.statistics_employee);
    ...
    private void drawEmployeeChart(JSONArray jArr){
        ...
        try {
            for (int i = 0; i < jArr.length(); i++) {
                ...
                yvalues.add(new PieEntry(jObj.getInt("employees"), jObj.getString("name")));
            }

            PieDataSet dataSet = new PieDataSet(yvalues, "Employees");
